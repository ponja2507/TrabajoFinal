...
from AppProject.views import inicio, clientes, empleados, productos, crear_producto, editar_producto, eliminar_producto, crear_empleado, editar_empleado, eliminar_empleado, clienteFormulario
